            ...
            <div class="card-header align-items-center justify-content-start gap-md-5">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    <select class="form-select w-200px" name="status" data-control="select2" data-hide-search="true"
                        data-placeholder="Sắp xếp chương học" data-kt-ecommerce-product-filter="status">
        ...
        <div class="card-body pt-0 p-10 p-lg-15">
            ...
            <div class="d-flex flex-stack mb-7">
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{ route('manager.course.learning-roadmap.chapter.create-page', ['course_id' => $course->id]) }}"
                        class="btn btn-sm btn-success">
                        <i class="ki-outline ki-plus fs-2"></i>
                        Thêm chương học
                    </a>
                    <a href="{{ route('manager.course.learning-roadmap.chapter.record-order-page', ['course_id' => $course->id]) }}"
                ...
                <div class="border bg-secondary p-5 mb-5 rounded">
                    <div class="btn-group mx-10" role="group" aria-label="Basic example">
                        <a class="btn btn-sm btn-warning"
                            href="{{ route('manager.course.learning-roadmap.chapter.edit-page', ['course_id' => $course->id, 'chapter_id' => $chapter->id]) }}">
                            Sửa chương học
                        </a>
                        ...
                        <a href="{{ route('manager.course.learning-roadmap.lesson.create-page', ['course_id' => $course->id, 'chapter_id' => $chapter->id]) }}"
                            class="btn btn-sm btn-success">
                            <i class="ki-outline ki-plus fs-2"></i>
                            Thêm bài học
                        </a>

                        <a href="{{ route('manager.course.learning-roadmap.lesson.record-order-page', ['course_id' => $course->id, 'chapter_id' => $chapter->id]) }}"
                            class="btn btn-sm btn-primary">
                            <i class="bi bi-sort-down-alt fs2"></i>
                            Sắp xếp bài học
                        </a>
                    ...
                    <div class="m-0">
                        ...
                        <div id="kt_support_{{ $chapter->id }}" class=" collapse show fs-6 ms-10" style="">
                            ...
                            <div class="mb-4">
                                ...
                                @forelse ($chapter->lessons as $lesson)
                                    <div class="border bg-white p-5 mb-5 rounded">
                                        <div class="btn-group mb-5" role="group" aria-label="Basic example">
                                            <a class="btn btn-sm btn-warning"
                                                href="{{ route('manager.course.learning-roadmap.lesson.edit-page', ['course_id' => $course->id, 'chapter_id' => $chapter->id, 'lesson_id' => $lesson->id]) }}">
                                                Sửa bài học
                                            </a>

                                            <a class="btn btn-sm btn-primary"
                                                href="{{ route('manager.course.learning-roadmap.lesson.video-create-page', ['course_id' => $course->id, 'chapter_id' => $chapter->id, 'lesson_id' => $lesson->id]) }}">
                                                Tải video lên
                                            </a>
                                            ...
                                            <a class="btn btn-sm btn-info"
                                                href="{{ route('manager.course.learning-roadmap.lesson.detail-page', ['course_id' => $course->id]) }}">
                                                Chi tiết
                                            </a>
                                        </div>
                                ...
                                @empty
                                    <svg xmlns="http://www.w3.org/2000/svg" class="fs-3 text-danger me-2" width="16"
