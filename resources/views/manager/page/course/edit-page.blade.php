    ...
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div class="card card-custom gutter-b example example-compact card-validate-form card-sticky">
            ...
            <form class="validate-form" id="validate-form" data-kt-redirect-url="{{ route('manager.course.list-page') }}"
                method="PUT" action="{{ route('manager.course.update', ['course_id' => $course->id]) }}">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="mb-15">
                        ...
                        <div class="form-group form-ajax-validate row mb-3">
                            <label class="col-lg-3 col-form-label" for="image_path">Hình ảnh:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group form-ajax-validate row mb-3">
                            <label class="col-lg-3 col-form-label" for="release_datetime">Ngày giờ triển
                                khai:</label>
                            <div class="col-lg-6">
                                <input type="text" name="release_datetime" id="release_datetime"
                                    class="form-control ajax-input-css-display" placeholder="nhập ngày giờ triển khai"
                                    value="{{ $course->release_datetime }}">
                                <span class="ajax-msg-display-release_datetime form-text text-danger"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group form-ajax-validate row mb-3">
                            ...
                            <div class="col-lg-6">
                                <textarea name="description" id="description" class="form-control ajax-input-css-display">{!! $course->description !!}</textarea>
