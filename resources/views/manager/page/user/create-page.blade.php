            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <li class="breadcrumb-item text-dark">
                        <a class="text-dark">Tạo người dùng</a>
                    </li>
...
@section('kt_app_content')
    <div id="kt_app_content" class="app-content flex-column-fluid">
        <div class="card card-custom gutter-b example example-compact card-validate-form card-sticky">
            ...
            <!--begin::Form-->
            <form class="validate-form" id="validate-form" data-kt-redirect-url="{{ route('manager.user.list-page') }}"
                method="POST" action="{{ route('manager.user.store') }}">
                @csrf
                @method('POST')
                <div class="card-body">
                    <div class="mb-15">
                        ...
                        <div class="form-group form-ajax-validate row mb-3">
                            <label class="col-lg-3 col-form-label required" for="password">Mật khẩu:</label>
                            <div class="col-lg-6">
                        ...
                        <div class="form-group form-ajax-validate row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text" name="phone_number" id="phone_number"
                                    class="form-control ajax-input-css-display" placeholder="Nhập số điện thoại">
                                <span class="ajax-msg-display-phone_number form-text text-danger"></span>
                            </div>
                        </div>

                        <div class="form-group form-ajax-validate row mb-3">
                            <label class="col-lg-3 col-form-label required" for="avatar_path">Hình ảnh cá nhân:</label>
                            <div class="col-lg-6">
