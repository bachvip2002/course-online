        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
            ...
            <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
                ...
                <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form"
                            data-kt-redirect-url="../../demo34/dist/index.html" action="#">
                            <!--begin::Heading-->
                            ...
                            <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
                                <div></div>
                                <!--begin::Link-->
                                <a href="../../demo34/dist/authentication/layouts/corporate/reset-password.html"
                            ...
                            <div class="text-gray-500 text-center fw-semibold fs-6">Not a Member yet?
                                <a href="../../demo34/dist/authentication/layouts/corporate/sign-up.html"
                ...
                <div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
                    ...
                    <div class="d-flex fw-semibold text-primary fs-base gap-5">
                        <a href="../../demo34/dist/pages/team.html" target="_blank">Terms</a>
                        <a href="../../demo34/dist/pages/pricing/column.html" target="_blank">Plans</a>
                        <a href="../../demo34/dist/pages/contact.html" target="_blank">Contact Us</a>
                    </div>
                    <!--end::Links-->
                </div>
                <!--end::Footer-->
            ...
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
                ...
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    <!--begin::Logo-->
                    <a href="../../demo34/dist/index.html" class="mb-0 mb-lg-12">
